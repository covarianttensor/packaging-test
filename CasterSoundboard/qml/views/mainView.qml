...
ApplicationWindow {
    ...
    function handleKeyboardPressEvent(sourceComponentName, key){
        console.log("handleKeyboardPressEvent[" + sourceComponentName + "] -> " + " + " + key)
    }

    Component.onCompleted: {
        mainSideNav.onKeyPressedEvent.connect(root.handleKeyboardPressEvent)
    }
    ...
    Rectangle {
        ...
        signal onKeyPressedEvent(string sourceComponentName, int key)

        Keys.onPressed: {
            onKeyPressedEvent("mainSideNav", event.key)
        }
